...
const ControlBar = ({
  ...
  return (
    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-zinc-900/40 backdrop-blur-2xl p-2 px-4 rounded-[20px] border border-white/10 shadow-[0_15px_40px_rgba(0,0,0,0.5)] transition-all duration-300 hover:border-white/20">
      ...
      <div className="flex items-center gap-2 pr-3 border-r border-white/10 mr-1">
        {isUserSpeaking ? (
          <div className="flex items-center gap-2 px-2 py-1 bg-primary/10 rounded-full border border-primary/20 animate-in fade-in zoom-in duration-300">
            ...
            <span className="text-[9px] font-black text-primary uppercase tracking-widest">Listening</span>
          </div>
        ) : isAiThinking ? (
          <div className="flex items-center gap-2 px-2 py-1 bg-amber-500/10 rounded-full border border-amber-500/20 animate-in fade-in zoom-in duration-300">
            ...
            <span className="text-[9px] font-black text-amber-400 uppercase tracking-widest">Thinking</span>
          </div>
        ) : isAgentSpeaking ? (
          <div className="flex items-center gap-2 px-2 py-1 bg-blue-500/10 rounded-full border border-blue-500/20 animate-in fade-in zoom-in duration-300">
            ...
            <span className="text-[9px] font-black text-blue-400 uppercase tracking-widest">Speaking</span>
          </div>
        ) : (
          <div className="flex items-center gap-2 px-2 py-1 bg-zinc-800/50 rounded-full border border-white/5 opacity-60">
            <div className="w-1 h-1 bg-zinc-500 rounded-full" />
            <span className="text-[9px] font-black text-zinc-500 uppercase tracking-widest">Standby</span>
          </div>
        )}
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <div className={`absolute -top-10 left-1/2 -translate-x-1/2 px-2 py-1 bg-zinc-800 text-white text-[9px] font-bold rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-white/10`}>
