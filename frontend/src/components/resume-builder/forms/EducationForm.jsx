...
const EducationForm = () => {
  ...
  useEffect(() => {
    if (education.length === 0 && editingIndex === null) {
      handleAdd();
    }
  }, [education.length]);
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. BTech Computer Science - CGPA 7.73"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <MonthYearPicker
                ...
                onChange={(val) => setEditEntry({ ...editEntry, endDate: val })}
                align="right"
                showPresent={true}
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-lime-500/50 transition-all min-h-[100px] resize-none"
