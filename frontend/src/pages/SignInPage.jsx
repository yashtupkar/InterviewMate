    ...
    <div className="min-h-screen  flex items-center justify-center p-6 relative">
      ...
      <div className="auth-card-container animate-fade w-full max-w-[440px]">
        {/* <div className="mb-8 text-center">
            <h1 className="text-3xl font-black tracking-tight text-white mb-2">Welcome <span className="text-[#bef264]">Back</span>.</h1>
            <p className="text-zinc-500 font-bold uppercase tracking-[0.2em] text-[10px]">Continue your prep journey</p>
        </div> */}
