  ...
  return (
    <>
      ...
      <div className="min-h-screen text-zinc-100 transition-colors selection:bg-[#bef264]/30 pb-20 p-4 md:p-4  ">
        {/* Container */}
        <div
          className={`flex flex-col lg:flex-row items-start justify-center gap-12 mx-auto relative transition-all duration-700 ${result ? "max-w-7xl" : "max-w-6xl"}`}
        >
          ...
          {loading ? (
            ...
            <>
              {/* Left Side: Info */}
              <div
                className={`w-full lg:w-1/2 flex flex-col lg:sticky lg:top-16 h-fit space-y-4 sm:space-y-6 animate-in slide-in-from-left-8 fade-in duration-700 ${isSmallScreen && mobileStage === 2 ? "hidden" : ""}`}
              >
                <div className="space-y-4">
                  ...
                  <h1 className="text-2xl sm:text-3xl md:text-5xl font-black text-white tracking-tight leading-tight">
                    Is your{" "}
                    <span className="text-[#bef264] italic">resume</span> good
                    enough?
                  </h1>
                  <p className="text-zinc-500 text-sm font-medium leading-relaxed max-w-md mt-4">
                    Upload your resume and paste the job description. Our
                    advanced AI will analyze your match, identify missing
                    keywords, and provide actionable feedback tailored to the
                    specific role.
                  </p>
                </div>
                ...
                {isSmallScreen && mobileStage === 1 && (
                  ...
                  >
                    Proceed to Scan Details
                  </button>
                )}
                <div className="sm:bg-[#1a1a1a] p-3 sm:p-7 shadow-xl sm:rounded-[2rem] sm:border dark:border-white/5 border-gray-100 ring-1 ring-black/5">
                  <h3 className="text-sm font-bold dark:text-white text-black mb-3 flex items-center uppercase tracking-widest">
                    <FiShield className="mr-3 text-[#bef264] text-xl" /> What We
                    Analyze
                  </h3>
                  <p className="text-[13px] dark:text-zinc-500 text-gray-600 leading-relaxed font-medium">
                    Get deep insights into Grammar & Spelling, File
                    parseability, ATS Formatting rules, and Tailored matching
              ...
              <div
                className={`w-full lg:w-[450px] flex flex-col animate-in slide-in-from-right-8 fade-in duration-700 ${isSmallScreen && mobileStage === 1 ? "hidden" : ""} ${isCompactMobileForm ? "gap-5 px-1 pt-2" : "gap-8 pt-10"}`}
              >
                <>
                  {isCompactMobileForm && (
                    <div className="flex items-center justify-between mb-1">
                      ...
                      >
                        <FiArrowRight size={14} className="rotate-180" /> Back
                      </button>
                  ...
                  <div className={isCompactMobileForm ? "pb-1" : "pb-2"}>
                    <h2
                      className={`${isCompactMobileForm ? "text-base" : "text-lg"} font-black text-white mb-1 uppercase tracking-tight`}
                    >
                      Scan details
                    </h2>
                    <p
                      className={`text-zinc-500 ${isCompactMobileForm ? "text-xs" : "text-sm"} font-medium`}
                    >
                  ...
                  <div
                    className={isCompactMobileForm ? "space-y-4" : "space-y-6"}
                  >
                    {/* File Upload */}
                    <div
                      className={
                    ...
                    >
                      ...
                      <textarea
                        ...
                        className={`w-full ${isCompactMobileForm ? "p-3 text-xs" : "p-5 text-[13px]"} bg-black border border-zinc-800 rounded-xl text-white focus:ring-1 focus:ring-[#bef264] transition-all outline-none resize-none font-medium placeholder-zinc-700 shadow-sm`}
                      ></textarea>
                    </div>
